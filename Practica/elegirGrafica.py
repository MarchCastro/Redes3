...
class VentanaGraficas(object):
	...
	def create_window(self):
		...
		tk.Button(self.window, text='Linea de base', command= lambda: self.inicia_ventana_grafica(1)).grid(row=1, column=1)
		...
		tk.Button(self.window, text='Linea de base', command= lambda: self.inicia_ventana_grafica(2)).grid(row=2, column=1)
		...
		tk.Button(self.window, text='Linea de base', command= lambda: self.inicia_ventana_grafica(3)).grid(row=3, column=1)
		...
		tk.Button(self.window, text='Linea de base', command= lambda: self.inicia_ventana_grafica(4)).grid(row=4, column=1)
		...
		tk.Button(self.window, text='Linea de base', command= lambda: self.inicia_ventana_grafica(5)).grid(row=5, column=1)
