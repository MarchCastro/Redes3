...
\textbf{Consulta SNMP: egpInMsgs Windows OID: 1.3.6.1.2.1.8.1.0 (figura \ref{image:11-W}) y Centos (figura \ref{image:11-C})}
\FloatBarrier
\begin{figure}[htbp!]
		\centering
...
\begin{figure}[htbp!]
	...
	\includegraphics[width=.9 \textwidth]{images/13-c1}
		\caption{Muestra el valor de sysContact(4) y se modifica por ''CentOS" finalmente muestra el cambio.}		\label{image:13-c1}
\end{figure}
\FloatBarrier
